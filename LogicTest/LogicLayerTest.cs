...
namespace LogicTest
{
    ...
    public class LogicLayerTest
    {
        ...
        {
            var fake = new FakeEvents();
            var buyer = new Buy_class(fake);
            fake.Add2State("Apple", 2);
            fake.Add2State("Banana", 1);
            fake.Add2Cat("Apple", (float)2.50);
            fake.Add2Cat("Banana", (float)3.20);
        ...
        {
            var fake = new FakeEvents();
            var supplier = new Supply_class(fake);
            fake.Add2State("Apple", 1);
            fake.Add2State("Television", 0);
            fake.Add2Cat("Apple", (float)5.00);
            fake.Add2Cat("Television", (float)100.00);
